...
<head>
    ...
    */
     ...
     */
     ...
     .dropdown_share:hover .dropbtn{background-color:none;}
   /**
     main menu style 
   */
    .main{
    ...
    .post{
        ...
        //border-width:.5px;*/
        margin:40px; 
        box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2) ,  0px 8px 16px 0px rgba(0,0,0,0.2) ,0px 8px 16px 0px rgba(0,0,0,0.2) ;
    }
    .choice{
       display:grid;
...
<!-- edited -->
<div class="main">
<?php $postarray = $obj->get_user_post($conn, $userid);?>
<?php
$int = 0;
foreach($postarray as $post){?>
<div class="post" id="<?php echo $post['post_id']?>">
<div class="subject">
<p><?php echo "subject: ". $userid . $post['subject'] ?></p>
</div><!--end of subject-->
<div class="posttext">
...
Posted by
                        <span class="glyphicon glyphicon-user "></span><a href="linkprofile.php"><?php echo " " . $post['full_name'] ?></a>
                    </p><!-- end of user post-->
